...
class SessionForm extends React.Component {
    ...
    render() {
        ...
        const birthday = `${year}/${day}/${months[month] + 1 < 10 ? '0' + months[month] + 1 : months[month] + 1}`
            ...
            <div className='signup'>
                ...
                <main>
                    <form onSubmit={this.handleSubmit} className="forms-container" >
                        <section className="personal-info">
                            ...
                            <div className="personal-info-birthdate">
                                <div className="control-group">
                                    <label htmlFor="dob-day" className="control-label">Date of birth <span className="required-marker">*</span></label>
                        ...
                        <section>
                            {
                                <input type="hidden" name="" value={birthday}/> 
                            }
                        </section>
